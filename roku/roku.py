...
@click.option('--verbose', '-v', is_flag=True, 
	help='Print log of each step.')
@click.option('--tuples', '-t', is_flag=True, 
	help='Print the tuples generated by the lexical analyser.')
@click.option('--ast', '-a', is_flag=True, 
	help='Print the generated abstract syntax tree.')
@click.option('--decorated', '-d', is_flag=True, 
	help='Print the generated abstract syntax tree with type decorations.')
@click.option('--mid', '-m', is_flag=True, 
	help='Print the generated mid-code assembly tuples.')
@click.option('--bonus', '-b', is_flag=True, 
	help='Bonus option.')
